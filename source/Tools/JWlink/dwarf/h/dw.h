...
typedef struct _dw_client *      dw_client;

/* used for macro definitions */
typedef struct _dw_macro *       dw_macro;

/* temporary value that is used to build location expressions */
typedef struct _dw_loc_id *      dw_loc_id;
...
typedef struct _dw_list_id *     dw_list_id;

/* a 'compiled' location expression or list */
typedef struct _dw_loc_handle *  dw_loc_handle;
